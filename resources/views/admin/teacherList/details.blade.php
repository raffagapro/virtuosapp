      ...
      <div class="modal-body">
        <form action="{{ route('maestros.update', $teacher->id) }}" method="POST">
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="modNombre" placeholder="Nombre" value="{{ $teacher->name }}">
          </div>
          {{--  Email  --}}
          <div class="form-group">
            <input type="mail" class="form-control" name="modEmail" placeholder="Correo" value="{{ $teacher->email }}">
          </div>
          {{--  CURP  --}}
          <div class="form-group">
            <input type="text" class="form-control" name="modCurp" placeholder="CURP" value="{{ $teacher->curp }}">
          </div>
          {{--  AREA  --}}
          <div class="form-group">
